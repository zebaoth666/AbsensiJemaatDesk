    ...
    public partial class frmKoneksi : Form
    {
        ...
        private void btnTes_Click(object sender, EventArgs e)
        {
            ...
            else if (string.IsNullOrEmpty(txtUser.Text))
            {
                ...
                conn = new connClass(txtServer.Text, txtPort.Text, txtUser.Text, txtPassword.Text, null);
                if (conn.testConn())
                {
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            {
                iMessage.eBoxOk("Silakan pilih database yang tersedia");
            }
            else {
                conn.setDb(cmbDatabase.Text);
                xmlClass.createXml(txtServer.Text, txtPort.Text, txtUser.Text, txtPassword.Text, cmbDatabase.Text);
                Application.Restart();                
                this.Dispose();                
            }
        }
